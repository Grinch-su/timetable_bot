...
def get_table(message):
    ...
    rows = open_sheet.col_values(colx=21, start_rowx=4, end_rowx=15)
    row = '\n'.join(rows)
...
def get_table(message):
    ...
    open_sheet = open_xls.sheet_by_index(0)
    bot.send_message(message.chat.id, open_sheet.cell_value(0, 5))
    rows = open_sheet.col_values(colx=23, start_rowx=4, end_rowx=15)
    row = '\n'.join(rows)
    bot.send_message(message.chat.id, row)
...
def get_table(message):
    ...
    open_sheet = open_xls.sheet_by_index(0)
    bot.send_message(message.chat.id, open_sheet.cell_value(0, 5))
    rows = open_sheet.col_values(colx=19, start_rowx=4, end_rowx=15)
    row = '\n'.join(rows)
    bot.send_message(message.chat.id, row)
...
def get_table(message):
    ...
    open_sheet = open_xls.sheet_by_index(0)
    bot.send_message(message.chat.id, open_sheet.cell_value(0, 5))
    rows = open_sheet.col_values(colx = 15,start_rowx = 4,end_rowx = 15)
    row = '\n'.join(rows)
    bot.send_message(message.chat.id,row)
...
def get_table(message):
    ...
    open_sheet = open_xls.sheet_by_index(0)
    bot.send_message(message.chat.id, open_sheet.cell_value(0, 5))
    rows = open_sheet.col_values(colx=17, start_rowx=4, end_rowx=15)
    row = '\n'.join(rows)
    bot.send_message(message.chat.id, row)
...
def get_table(message):
    ...
    open_sheet = open_xls.sheet_by_index(0)
    bot.send_message(message.chat.id, open_sheet.cell_value(0, 5))
    rows = open_sheet.col_values(colx=13, start_rowx=4, end_rowx=15)
    row = '\n'.join(rows)
    bot.send_message(message.chat.id, row)
...
def get_table(message):
    ...
    open_sheet = open_xls.sheet_by_index(0)
    bot.send_message(message.chat.id, open_sheet.cell_value(0, 5))
    rows = open_sheet.col_values(colx=3, start_rowx=4, end_rowx=15)
    row = '\n'.join(rows)
    bot.send_message(message.chat.id, row)
...
def get_table(message):
    ...
    open_sheet = open_xls.sheet_by_index(0)
    bot.send_message(message.chat.id, open_sheet.cell_value(0, 5))
    rows = open_sheet.col_values(colx=5, start_rowx=4, end_rowx=15)
    row = '\n'.join(rows)
    bot.send_message(message.chat.id, row)
...
def get_table(message):
    ...
    open_sheet = open_xls.sheet_by_index(0)
    bot.send_message(message.chat.id, open_sheet.cell_value(0, 5))
    rows = open_sheet.col_values(colx=7, start_rowx=4, end_rowx=15)
    row = '\n'.join(rows)
    bot.send_message(message.chat.id, row)
...
def get_table(message):
    ...
    open_sheet = open_xls.sheet_by_index(0)
    bot.send_message(message.chat.id, open_sheet.cell_value(0, 5))
    rows = open_sheet.col_values(colx = 9, start_rowx = 4, end_rowx = 15)
    row = '\n'.join(rows)
    bot.send_message(message.chat.id, row)
...
def get_table(message):
    ...
    open_sheet = open_xls.sheet_by_index(0)
    bot.send_message(message.chat.id, open_sheet.cell_value(0, 5))
    rows = open_sheet.col_values(colx = 11, start_rowx = 4, end_rowx = 15)
    row = '\n'.join(rows)
    bot.send_message(message.chat.id, row)
